...
<div class="min-h-screen bg-blue-50">
    <x-hero title="Crear Nuevo Producto" subtitle="Rellena los datos para publicar un producto en el catálogo." />
            ...
            <form action="{{ route('admin.products.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="unit" placeholder="ej: pieza, kg, m" value="{{ old('unit') }}" required
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg border-l-4 border-blue-600">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="color" placeholder="Ej: Gris, Rojo, Azul..." value="{{ old('color') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-bold mb-2">Rendimiento</label>
                            <input type="text" name="performance" placeholder="Ej: 300 cm², 50 m²..." value="{{ old('performance') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="material_type" placeholder="Ej: Acero, Polvo, Cerámica..." value="{{ old('material_type') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-bold mb-2">Peso</label>
                            <input type="text" name="weight_spec" placeholder="Ej: 50 kg, 2.5 kg..." value="{{ old('weight_spec') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="accessories" placeholder="Ej: No, Incluye aplicador, Incluye brocha..." value="{{ old('accessories') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-bold mb-2">Garantía Proveedor</label>
                            <input type="text" name="warranty" placeholder="Ej: 90 días, 1 año, Sin garantía..." value="{{ old('warranty') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="package_content" placeholder="Ej: 1 bulto de 50 kg, 5 piezas..." value="{{ old('package_content') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-bold mb-2">Modelo</label>
                            <input type="text" name="model_spec" placeholder="Ej: CPC 30R RS, XYZ-500..." value="{{ old('model_spec') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="height_spec" placeholder="Ej: 61" value="{{ old('height_spec') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-bold mb-2">Ancho (cm)</label>
                            <input type="text" name="width_spec" placeholder="Ej: 43" value="{{ old('width_spec') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-bold mb-2">Largo (cm)</label>
                            <input type="text" name="length_spec" placeholder="Ej: 62" value="{{ old('length_spec') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-bold mb-2">Profundidad (cm)</label>
                            <input type="text" name="depth_spec" placeholder="Ej: 19" value="{{ old('depth_spec') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="capacity" placeholder="Ej: Resistencia de hasta 300 kg/cm²..." value="{{ old('capacity') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-bold mb-2">Número de Piezas</label>
                            <input type="text" name="pieces_count" placeholder="Ej: 1, 5, 10..." value="{{ old('pieces_count') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="benefits" id="benefits" rows="2" placeholder="Ej: Resistencia al agua, durabilidad, bajo costo..."
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('benefits') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="materials" id="materials" rows="2" placeholder="Ej: Acero galvanizado, pintura epóxica..."
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('materials') }}</textarea>
                    </div>
                </div>
